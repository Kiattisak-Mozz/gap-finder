...
const dict = {
  th: {
    ...
    /* Trading Monitor */
    'nav.monitor': 'บอทเทรด',
    'mon.title': 'บอทเทรด AI',
    'mon.subtitle': 'ติดตามการทำงานของบอทแบบเรียลไทม์ — ยอดเงิน, สัญญาณ, และคำสั่งซื้อขายอัตโนมัติ',
    'mon.waiting': 'รอการเชื่อมต่อจาก Bot...',
    'mon.balance': 'ยอดเงิน',
    'mon.available': 'ใช้ได้',
    'mon.dailyPnl': 'กำไร/ขาดทุนรายวัน',
    'mon.openPos': 'Position เปิด',
    'mon.risk': 'ระดับความเสี่ยง',
    'mon.risk.high': 'สูง',
    'mon.scanner': 'Market Scanner',
    'mon.cycle': 'รอบที่',
    'mon.th.pair': 'คู่เทรด',
    'mon.th.price': 'ราคา',
    'mon.th.trend': 'เทรนด์',
    'mon.th.signal': 'สัญญาณ',
    'mon.openPositions': 'Position ที่เปิดอยู่',
    'mon.noPositions': 'ยังไม่มี Position เปิดอยู่',
    'mon.activityLog': 'บันทึกกิจกรรม',
    'mon.entries': 'รายการ',
    'mon.nextScan': 'สแกนถัดไป',
    'mon.history': 'ประวัติเทรด',
    'mon.noTrades': 'ยังไม่มีประวัติการเทรด',
  },
  en: {
    ...
    /* Trading Monitor */
    'nav.monitor': 'Trade Bot',
    'mon.title': 'AI Trade Bot',
    'mon.subtitle': 'Real-time bot activity — balance, signals, and automated orders',
    'mon.waiting': 'Waiting for bot connection...',
    'mon.balance': 'Balance',
    'mon.available': 'Available',
    'mon.dailyPnl': 'Daily PnL',
    'mon.openPos': 'Open Positions',
    'mon.risk': 'Risk Level',
    'mon.risk.high': 'HIGH',
    'mon.scanner': 'Market Scanner',
    'mon.cycle': 'Cycle',
    ...
    'mon.th.price': 'Price',
    'mon.th.trend': 'Trend',
    'mon.th.signal': 'Signal',
    'mon.openPositions': 'Open Positions',
    'mon.noPositions': 'No open positions',
    'mon.activityLog': 'Activity Log',
    'mon.entries': 'entries',
    'mon.nextScan': 'Next scan',
    'mon.history': 'Trade History',
    'mon.noTrades': 'No trade history yet',
  },
}
